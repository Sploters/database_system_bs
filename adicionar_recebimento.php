...
?>
	...
	<form action="_insert_recebimento.php" method="post">
		...
		<div class="form-group" style="margin-top: 20px">
	    	...
	    	<input type="text" class="form-control" required autocomplete="off" value="<?php echo $nome_usuario ?>" disabled="disabled">
  		</div>
...
<select class="selectpicker form-control" id="mySelect" onchange="origem_empresa(this)">
	...
	if(val.value == 'jfr'){
     ...
     if(val.value == 'cli1'){
		...
		<div id="ng" class="form-group" style="margin-top: 20px">
	    	...
	    	<select name ="status_recebimento" class="form-control" id="origem_empresa_ng" onchange="origem_empresa(this)">
				<optgroup label="NG">
				<option id="selecione" value="selecione" selected="selected" disabled="disabled">Selecione...</option>
		...
		<div class="form-group" style="margin-top: 20px">
	    	<label id="idr" onchange="origem_empresa(this)" selected="selected">IDR</label>
	    	<label id="mc" onchange="origem_empresa(this)">MC</label>
	    	<input type="text" value="100.21" name="idr" class="form-control" required autocomplete="off" placeholder="IDR" disabled="disabled">
  		</div>

  		<div class="form-group" style="margin-top: 20px">
	    	<label>Data</label>
	    	<input type="text" id="data" class="form-control" required autocomplete="off" value="<?php $hoje = date('d/m/Y'); echo $hoje; ?>">
  		</div>
  		...
  		<div class="form-group" style="margin-top: 20px">
	    	...
	    	<input type="text" name="nf" class="form-control" required autocomplete="off" placeholder="Nº NF">
  		</div>
		...
		<script type="text/javascript">
  		...
  		<div id="nome_forn" class="form-group" style="margin-top: 20px">
	    	...
	    	<input type="text" value="<?php echo $nome_fornecedor?>" name="nome_fornecedor" class="form-control" required autocomplete="off" disabled="disabled">
  		</div>
...
<!--value="<?php echo $qtd_receb?>"-->
		...
		<?php 	
  		...
  		<div class="form-group" style="margin-top: 20px">
	    	...
	    	<input type="text" value="<?php echo $den_material ?>" name="den_material" class="form-control" required autocomplete="off" disabled="disabled">
  		</div>

  		<div class="form-group" style="margin-top: 20px">
	    	<label>Dimensão</label>
	    	<input type="text" value="<?php echo $dim_material ?>" name="dim_material" class="form-control" required autocomplete="off" disabled="disabled">
  		</div>

  		<div class="form-group" style="margin-top: 20px">
	    	<label>Material</label>
	    	<input type="text" value="<?php echo $mat_material ?>" name="mat_material" class="form-control" required autocomplete="off" disabled="disabled">
  		</div>
  		...
  		<div class="form-group" style="margin-top: 20px">
	    	...
	    	<input type="text" name="id_fornecedor" class="form-control" required autocomplete="off" placeholder="Volume Corrida">
  		</div>
  		...
  		<div class="form-group" style="margin-top: 20px">
	    	...
	    	<select name ="status_recebimento" class="form-control">
				<optgroup>
